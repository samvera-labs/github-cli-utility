...
class Samvera::Github::Projects < Samvera::Github
  ...
  def create
    ...
    repository.create_project(name: project_name, body: project_body)
    say("Successfully created the Project #{project_name} for the Repository: #{repository.name}", :green)
  ...
  def delete
    ...
    repository.delete_project(name: project_name)
    say("Successfully deleted the Project #{project_name} for the Repository: #{repository.name}", :green)
  rescue Octokit::Unauthorized => authz_error
    say("Error: #{authz_error}", :red)
  end
end
